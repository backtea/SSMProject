			...
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<ul>
						...
						<li>
							<#if (userinfo.authscore<userinfo.creditBorrowScore)>
								<a href="#">${userinfo.authscore}分</a>
								<a href="#">材料认证分数达到${userinfo.creditBorrowScore}分</a>
								<span class="glyphicon glyphicon-remove" style="color:red;"></span>
							<#else>
								材料认证分数达到${userinfo.creditBorrowScore}分<span class="glyphicon glyphicon-ok" style="color:green;">
							</span></#if>
						</li>
					</ul>
					<#if userinfo.isBasicInfo && userinfo.isBindPhone && userinfo.isBindEmail
					        && (userinfo.authscore >= userinfo.creditBorrowScore) >
